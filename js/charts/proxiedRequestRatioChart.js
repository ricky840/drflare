var proxiedRequestRatioChart = (function(global) {
  'use strict';

  var chart = am4core.create("proxied-request-ratio-chart", am4charts.GaugeChart);
	...
	axis.min = 0;
	axis.max = 100;
	axis.strictMinMax = true; axis.renderer.radius = am4core.percent(80);
  ...
  label2.text = "CLOUDFLARE PROXIED";
  label2.align = "center";

  global.createdCharts['proxiedRequestRatioChart'] = chart;
